...
$app->post('/api/BestBuy/getProductBySearchQuery', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'apiKey','searchQuery'=>'searchQuery'];
    ...
    $bodyParams = [
       'query' => ['apiKey','page','pageSize','cursorMask','sort','show']
    ];
    ...
    $query_str = "https://api.bestbuy.com/v1/products({$data['searchQuery']})";
